...
var _lodash = require('lodash.isarraylike');
...
function buildFilterQuery(args) {
  ...
  // back as an array
  if ((0, _lodash2.default)(args) && args.length && args.length > 0) {
        ...
        default:
          switch (operation) {
            ...
            case 'not':
              ...
              var subQuery = buildFilterQuery(value);
